                            ...
                            <tbody class="">
                                ...
                                @foreach ($result as $key => $result)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn-primary btn-sm btn cursor-pointer" title="Edit"
                                                href="{{ route($folder_name . '-edit', ['id' => $result->e_id]) }}"> <i
                                                    class="icon-edit"></i>
                                            </a>
                                            <a class="btn-danger btn-sm btn cursor-pointer" title="Delete"
                                                href="{{ route($folder_name . '-delete', ['id' => $result->id]) }}"> <i
                                                    class="icon-remove"></i>
                                            </a>
